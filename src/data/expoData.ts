export const expoData = {
    ...
    packages: [
...

            {
                ...
                note: "Most exhibitors integrate the B2B meetings program to maximize ROI and accelerate market access."
            }
        ],

        buyerProfiles: [
            "Importers", "Distributors", "Retail chains", "Pharmacy groups",
            "E-commerce platforms", "Hospitality buyers", "Wellness retailers", "Cosmetic distributors"
        ],

        sectors: [
            "Organic food", "Functional beverages", "Superfoods", "Natural cosmetics",
            "Essential oils", "Wellness products", "Herbal products", "Nutritional supplements",
        ...
        trackRecord: [
            ...
            { metric: "30,000+", label: "B2B Meetings Organized" },
            { metric: "$100M+", label: "Business Generated" }
        ]
};